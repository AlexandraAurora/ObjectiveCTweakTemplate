//
//  TweakRootListController.m
//  Tweak
//
//  Created by Alexandra Aurora Göttlicher
//

#include "TweakRootListController.h"
...
- (void)promptToRespring {
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Tweak" message:@"This option requires a respring to apply. Do you want to respring now?" preferredStyle:UIAlertControllerStyleAlert];
